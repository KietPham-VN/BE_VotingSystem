...
namespace BE_VotingSystem.Infrastructure.Database.Migrations
{
    ...
    [Migration("20250929160359_AddLecturerAccountName_Fix")]
    partial class AddLecturerAccountName_Fix
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("BE_VotingSystem.Domain.Entities.FeedbackVote", b =>
                {
                    ...
                    b.ToTable("feedback_vote", null, t =>
                        {
                            t.HasCheckConstraint("CK_FeedbackVote_Vote", "Vote >= 1 AND Vote <= 5");
                        });
                });

            modelBuilder.Entity("BE_VotingSystem.Domain.Entities.Lecturer", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
            ...
            modelBuilder.Entity("BE_VotingSystem.Domain.Entities.LecturerVote", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("char(36)");
                    ...
                    b.ToTable("lecturer_vote", (string)null);
                });
            ...
            modelBuilder.Entity("BE_VotingSystem.Domain.Entities.WebImage", b =>
                {
                    b.Property<string>("Name")
                        .HasMaxLength(255)
                        .HasColumnType("varchar(255)");
            ...
            modelBuilder.Entity("BE_VotingSystem.Domain.Entities.LecturerVote", b =>
                {
                    ...
                    b.HasOne("BE_VotingSystem.Domain.Entities.Lecturer", "Lecture")
                        .WithMany("Votes")
