...
namespace BE_VotingSystem.Infrastructure.Database.Migrations
{
    ...
    [Migration("20250913080135_AddLectureAndLectureVoteTables")]
    partial class AddLectureAndLectureVoteTables
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("BE_VotingSystem.Domain.Entities.LectureVote", b =>
                {
                    ...
                    b.HasIndex("LectureId", "AccountId", "VotedDate")
                        .IsUnique();
